...
class DataDownloader():
    ...
    def stooq(self, symbol: str, start_date: str, end_date: str):
        """
    ...
    def yahoo(self, symbol: str, start_date: str, end_date: str, interval: str='1d'):
        """
...
if __name__ == '__main__':
    ...
    print(data_downloader.yahoo('AAPL', '2025-12-22', '2026-01-01', '1d'))
